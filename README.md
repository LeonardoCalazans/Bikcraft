...
```bash
# Clone o repositório
git clone https://github.com/leonardocalazans/Bikcraft
...
O projeto está sob a licença MIT. Para saber mais, acesse o arquivo [LICENSE](https://github.com/LeonardoCalazans/Bikcraft/blob/main/LICENSE).

---

**Desenvolvido por [Leonardo Calazans](https://github.com/leonardocalazans/).**
